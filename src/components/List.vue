<template>
<v-data-table :headers="headers" :items="schedules" sort-by="service" class="elevation-1">
    <template v-slot:top>
        <v-toolbar flat>
            <v-toolbar-title>Appoinment List</v-toolbar-title>
                    ...
                    <v-card-text>
                        <v-container>
                            <v-row>
                                ...
                                <v-col cols="12" sm="6" md="4">
                                    <v-text-field v-model="editedItem.services" label="Services"></v-text-field>
                                </v-col>
                            </v-row>
                        </v-container>
                    </v-card-text>
